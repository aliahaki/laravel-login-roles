                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 space-x-8">
                    ...
                    {{-- @if (Auth::check() && Auth::user()->rolename === 'praktijkmanagement')
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                                    <div>{{ __('Praktijkmanagement') }}</div>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('praktijkmanagement.index')">
                                    {{ __('Dashboard') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::check() && Auth::user()->rolename === 'praktijkmanagement')
                ...
                <x-responsive-nav-link :href="route('praktijkmanagement.index')">
